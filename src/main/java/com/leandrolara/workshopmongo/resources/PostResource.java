...
import com.leandrolara.workshopmongo.resources.util.URL;
...
public class PostResource {
	...
	public ResponseEntity<List<Post>> dindByTitle(@RequestParam(value="text", defaultValue = "") String text){
		text = URL.decodeParam(text);
		List<Post> list = service.findByTitle(text);
		return ResponseEntity.ok().body(list);
	} 
	
	@RequestMapping(value="/fulltitlesearch", method=RequestMethod.GET)
